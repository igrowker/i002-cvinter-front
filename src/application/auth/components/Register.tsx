...
const Register: React.FC = () => {
  ...
  const handleSubmitForm = (event: React.FormEvent) => {
    ...
    if (!formData.name || !formData.email || !formData.password) {
      console.log("asd do not!");
      toast("Error", {
        description: "Por favor, complete los campos solicitados.",
        icon: <VscError style={{ color: "red", fontSize: "1.5rem" }} />,
      });
    } else {
    ...
    <div className="flex flex-col md:flex-row w-full h-screen">
      ...
      <div className="w-full md:w-2/3 lg:w-1/2 flex items-center justify-center p-4">
        <div className="max-w-md w-full p-4">
          {/* <h2 className="text-xl font-lato font-extrabold mb-4">
            Create account
          </h2> */}
          {!mutation.isPending && (
            <>
              ...
              <form onSubmit={handleSubmitForm} className="space-y-4">
                ...
                >
                  ...
                  >
                    <path
                      fill="#EA4335"
                      d="M23.6 12.3c0-.8-.1-1.6-.2-2.3H12v4.3h6.5c-.3 1.6-1.2 3-2.6 4v3.3h4.2c2.5-2.4 3.9-5.8 3.9-9.6z"
                    />
                    <path
                      fill="#34A853"
                      d="M12 24c3.2 0 5.8-1 7.7-2.8l-4.2-3.3c-1 .6-2.3 1-3.5 1-2.7 0-5.1-1.8-5.9-4.3H2.8v3.4C4.7 21.4 8 24 12 24z"
                    />
                    <path
                      fill="#4A90E2"
                      d="M6.1 14.6c-.3-1.1-.3-2.2 0-3.3V8H2.8C1.4 10.5 1.4 13.5 2.8 16l3.3-2.4z"
                    />
                    <path
                      fill="#FBBC05"
                      d="M12 4.8c1.5 0 2.9.5 4 1.5l3-3C16.7 1.3 14.1 0 12 0 8 0 4.7 2.6 2.8 6l3.3 2.5c.8-2.5 3.2-4.3 5.9-4.3z"
                    />
                  </svg>
                  Continue with Google
                </button>
                <p className="text-center font-lato text-base text-[#98A2B3] mt-3">
                  ¿Ya tienes una cuenta?{" "}
                  <Link
                    to="/login"
                    className="font-lato text-base text-[#94B9FF] font-bold"
                  >
                    Log In
                  </Link>
                </p>
